...
```bash
dotnet add <项目.csproj> package 包名

dotnet remove <项目.csproj> package 包名

dotnet list <项目.csproj> package

# 恢复依赖：把项目声明的包下载到本机缓存并准备编译。
dotnet restore <解决方案.sln 或 项目.csproj>
```
...
1. `Directory.Packages.props` 集中版本管理
