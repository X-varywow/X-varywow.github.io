...
商业软件效果展示：https://www.ailabtools.com/zh-cn/retouch-portraits

---------------------



[modelscope 人物写真生成](https://modelscope.cn/studios/CVstudio/cv_human_portrait/summary)

[python 美颜代码](https://blog.51cto.com/u_16099230/7266173)

------------

在瘦脸变形方面，有几种常见的算法和开源项目可供使用：

1. 人脸关键点变形算法：这种算法通过对人脸关键点进行变形，实现瘦脸的效果。常见的开源项目包括dlib和OpenCV中的人脸关键点检测算法，可以用于定位人脸关键点，并通过对关键点进行变形来实现瘦脸。

2. 三维人脸建模算法：这种算法通过对人脸进行三维建模，可以更精确地进行瘦脸变形。开源项目中，Face++提供了一种基于3D人脸建模的瘦脸算法，可以实现更自然的瘦脸效果。

3. 网格变形算法：这种算法通过对人脸图像进行网格划分，然后对网格进行变形，实现瘦脸的效果。常见的开源项目包括dlib中的Thin Plate Spline（TPS）算法和OpenCV中的图像网格变形算法，可以用于实现瘦脸变形。


关键点检测，编辑计算，插值 实现瘦脸，，怎么这么淳朴

```python
# https://github.com/cytheria43/Face-Thin-Auto/blob/master/Face-Thin_Auto/Face-DetectAndThin.py
