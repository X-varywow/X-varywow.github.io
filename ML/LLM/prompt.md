...
现行 ai 产品的系统提示词收录：https://github.com/x1xhlol/system-prompts-and-models-of-ai-tools

常用技巧和思路：

</br>

#### 1. 用 XML 标签把指令划分为独立模块，而非一大段文字：

```xml
<tool_calling>工具调用规则</tool_calling>
<making_code_changes>代码修改规则</making_code_changes>
<communication>沟通风格</communication>
<debugging>调试策略</debugging>
```
...
同时告诉模型该做什么和绝对不能做什么，通常用 NEVER、IMPORTANT、CRITICAL 等强调词

"Run the lint command after changes"
...
其它：用简单例子代替解释，tool 精细控制， 多模式/角色架构，安全策略，记忆，案例倒逼设计