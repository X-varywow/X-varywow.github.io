...
正常核心内容：项目结构、规范， 对具体业务还应该包含：业务流程、业务（代码）术语
...
然后通过 `/command1` 在 聊天窗口运行，

本质是写一段提示词在 md 中，日常使用频次较少；

目前用处：（根据代码或提示）快速构建业务中可独立运行的代码，如查库（让 ai 拼接出上下文）用于快速 debug。文档中追加一些示例和错误示例，挺方便的。
