...
```bash
aws s3 sync /home/ec2-user/SageMaker s3://dataai-warehouse-stages/machine-learning/matchmaking/hzx_models/tmp_video_service

aws s3 sync /home/ec2-user/SageMaker/vitssvc s3://dataai-warehouse-stages/machine-learning/matchmaking/hzx_models/tmp_audio_service

aws s3 rm s3://dataai-warehouse-stages/machine-learning/matchmaking/hzx_models/s5_base --recursive
```
...
```python
import boto3
bucket = 'dataai-warehouse-stages'
