! function () {
    ...
    I.prototype.getBasePath = function () {
        ...
        return e = t.alias ? function e(n, i, o) {
            ...
            .test(i) ? i : /\/$/g.test(i) ? i + "README" + o : "" + i + o) === "/README" + r && t.homepage || e, e = T(e) ? e : q(a, e), e = n ? e.replace(new RegExp("^" + a), "") : e
    ...
    function jn(e, t) {
        return e.replace(/<(code|pre|script|template)[^>]*?>[\s\S]+?<\/(code|pre|script|template)>/g, function (e) {
            ...
            .replace(/:([a-z0-9_\-+]+?):/g, function (e, n) {
                return i = e, o = n, e = t, n = Rn.data[o], i, i = n ? e && /unicode/.test(n) ? '<span class="emoji">' + n.replace("unicode/", "")
                    .replace(/\.png.*/, "")
                    .split("-")
                    .map(function (e) {
                        return "&#x" + e + ";"
                    ...
                    .join("&zwj;")
                    .concat("&#xFE0E;") + "</span>" : '<img src="' + Rn.baseURL + n + '.png" alt="' + o + '" class="emoji" loading="lazy">' : i;
                var i, o
            })
            .replace(/__colon__/g, ":")
    }
        ...
        var u, f, p, d, n, g = function (u) {
            var i = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i,
                ...
                T = {
                    ...
                    util: {
                        encode: function e(n) {
                            return n instanceof C ? new C(n.type, e(n.content), n.alias) : Array.isArray(n) ? n.map(e) : n.replace(/&/g, "&amp;")
                                .replace(/</g, "&lt;")
                                .replace(/\u00a0/g, " ")
                        },
                        type: function (e) {
                    ...
                    highlightElement: function (e, n, i) {
                        ...
                        T.hooks.run("before-highlight", r), r.grammar ? n && u.Worker ? ((n = new Worker(T.filename))
    ...
    In.prototype.compileEmbed = function (e, n) {
        var i, o, t = On(n),
            a = t.str,
            t = t.config;
        if (n = a, t.include) return T(e) || (e = q(this.contentBase, R(this.router.getCurrentPath()), e)), t.type && (o = Hn[t.type]) ? (i = o.call(this, e, n))
        ...
        return t.heading = e.heading = function (e, n) {
            ...
            .renderer, c = n.router, u = n.linkTarget, n.linkRel, f = n.compilerClass, i.link = function (e, n, i) {
                var o = [],
                    ...
                    a = t.str,
                    t = t.config;
                return u = t.target || u, r = "_blank" === u ? f.config.externalLinkRel || "noopener" : "", n = a, T(e) || f._matchNotCompileLink(e) || t.ignore ? (T(e) || "./" !== e.slice(0, 2) || (e = document.URL.replace(/\/(?!.*\/).*/, "/")
                    .replace("#/./", "") + e), o.push(0 === e.indexOf("mailto:") ? "" : 'target="' + u + '"'), o.push(0 !== e.indexOf("mailto:") && "" !== r ? ' rel="' + r + '"' : "")) : (e === f.config.homepage && (e = "README"), e = c.toURL(e, null, c.getCurrentPath())), t.crossorgin && "_self" === u && "history" === f.config.routerMode && -1 === f.config.crossOriginLinks.indexOf(e) && f.config.crossOriginLinks.push(e), t.disabled && (o.push("disabled"), e = "javascript:void(0)"), t.class && o.push('class="' + t.class + '"'), t.id && o.push('id="' + t.id + '"'), n && o.push('title="' + n + '"'), '<a href="' + e + '" ' + o.join(" ") + ">" + i + "</a>"
            }), t.paragraph = {
                renderer: e
    ...
    function Wn(n, i, o, t, a, e) {
        n = e ? n : n.replace(/\/$/, ""), (n = R(n)) && X(a.router.getFile(n + o) + i, !1, a.config.requestHeaders)
            .then(t, function (e) {
                return Wn(n, i, o, t, a)
            })
    }
        ...
        return e && (n.__proto__ = e), ((n.prototype = Object.create(e && e.prototype))
            ...
            .prototype._renderTo = function (e, n, i) {
                ...
                S(l("main"), n ? "add" : "remove", "hidden"), e ? (S(o, "add", "show"), (n = (i = this.coverIsHTML ? e : this.compiler.cover(e))
                    .trim()
                    .match('<p><img.*?data-origin="(.*?)"[^a]+alt="(.*?)">([^<]*?)</p>$')) && ("color" === n[2] ? o.style.background = n[1] + (n[3] || "") : (e = n[1], S(o, "add", "has-mask"), T(n[1]) || (e = q(this.router.getBasePath(), n[1])), o.style.backgroundImage = "url(" + e + ")", o.style.backgroundSize = "cover", o.style.backgroundPosition = "center center"), i = i.replace(n[0], "")), this._renderTo(".cover-main", i), K()) : S(o, "remove", "show")
                ...
                u ? (e.repo && (f += (t = e.repo, r = e.cornerExternalLinkTarget, t ? '<a href="' + (t = (t = !/\/\//.test(t) ? "https://github.com/" + t : t)
                    ...
                    .name || "", "<main>" + ('<button class="sidebar-toggle" aria-label="Menu"><div class="sidebar-toggle-button"><span></span><span></span><span></span></div></button><aside class="sidebar">' 
                ...
                + '<section class="content"><div id="container"><article class="markdown-section" id="main">\x3c!--main--\x3e</article><footer><p>Copyright © 2020 - 2023 将心晴 | Powered by Docsify</p></footer></div></section></main>'
                        
                        ), 
                        this._renderTo(u, f, !0)) : this.rendered = !0, e.mergeNavbar && s ? p = b(".sidebar") : (c.classList.add("app-nav"), 
                        e.repo || c.classList.add("no-badge")), e.loadNavbar && y(p, c), e.themeColor && (v.head.appendChild(w("div", "<style>:root{--theme-color: " + e.themeColor + ";}</style>")
